...
[![AgentAudit](https://www.agentaudit.dev/api/badge/agentaudit-skill)](https://www.agentaudit.dev/packages/agentaudit-skill)
...
[![GitHub Stars](https://img.shields.io/github/stars/agentaudit-dev/agentaudit-skill?style=for-the-badge&color=yellow)](https://github.com/agentaudit-dev/agentaudit-skill)
...
- 📦 **Also available as npm package** — `npx agentaudit` for CLI + MCP server mode → [npmjs.com/package/agentaudit](https://www.npmjs.com/package/agentaudit) | [GitHub](https://github.com/agentaudit-dev/agentaudit-cli)
...
```bash
curl -sSL https://raw.githubusercontent.com/agentaudit-dev/agentaudit-skill/main/install.sh | bash
```
...
curl -sSL https://raw.githubusercontent.com/agentaudit-dev/agentaudit-skill/main/install.sh | bash -s -- --platform claude --agent my-agent
```

### Option 2: Git Clone <sup>(manual)</sup>

```bash
git clone https://github.com/agentaudit-dev/agentaudit-skill.git
cd agentaudit-skill
...
3. **Report issues** — Found a bug? [Open an issue](https://github.com/agentaudit-dev/agentaudit-skill/issues)
...
[AGPL-3.0](LICENSE) — Free for open source use. Commercial license available for proprietary integrations and SaaS deployments. [Contact us](https://github.com/agentaudit-dev/agentaudit-web/issues) for details.
...
[Visit Trust Registry](https://agentaudit.dev) • [View Leaderboard](https://agentaudit.dev/leaderboard) • [Report Issues](https://github.com/agentaudit-dev/agentaudit-skill/issues)
