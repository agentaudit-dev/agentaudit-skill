...
- 📦 **Also available as npm package** — `npx agentaudit` for CLI + MCP server mode → [npmjs.com/package/agentaudit](https://www.npmjs.com/package/agentaudit) | [GitHub](https://github.com/agentaudit-dev/agentaudit-mcp)
